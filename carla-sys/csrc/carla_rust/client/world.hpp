...
public:
    ...
    FfiActorVec GetTrafficLightsFromWaypoint(const FfiWaypoint& waypoint, double distance) const {
    ...
    void EnableEnvironmentObjects(const uint64_t* ids_ptr, size_t ids_len, bool enable) const {
    ...
    FfiLabelledPointList CastRay(FfiLocation start_location, FfiLocation end_location) const {
