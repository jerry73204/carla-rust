    ...
    namespace client {
        ...
        public:
            ...
            bool IsDynamic() const {
                return inner_->IsDynamic();
            }

            SignalOrientation GetOrientation() const {
                return inner_->GetOrientation();
            }

            double GetZOffset() const {
                return inner_->GetZOffset();
            }

            std::string GetCountry() const {
                return inner_->GetCountry();
            }
            ...
            std::string GetText() const {
                return inner_->GetText();
            }

            double GethOffset() const {
                return inner_->GethOffset();
            }

            double GetPitch() const {
                return inner_->GetPitch();
            }

            double GetRoll() const {
                return inner_->GetRoll();
            }
