...
struct carla_actor_attribute {
    ...
    std::shared_ptr<carla::client::ActorBlueprint> blueprint; // Keep blueprint alive
};
...
void carla_actor_set_transform(carla_actor_t* actor, const carla_transform_t* transform) {
...
void carla_actor_set_location(carla_actor_t* actor, const carla_vector3d_t* location) {
...
// Actor physics
void carla_actor_add_impulse(carla_actor_t* actor, const carla_vector3d_t* impulse) {
...
void carla_actor_add_angular_impulse(carla_actor_t* actor, const carla_vector3d_t* angular_impulse) {
    if (actor && actor->actor && angular_impulse) {
        try {
            carla::geom::Vector3D cpp_angular_impulse(angular_impulse->x, angular_impulse->y, angular_impulse->z);
...
void carla_actor_add_torque(carla_actor_t* actor, const carla_vector3d_t* torque) {
...
carla_actor_blueprint_t* carla_blueprint_library_at(carla_blueprint_library_t* library, size_t index) {
...
carla_actor_blueprint_t* carla_blueprint_library_find(carla_blueprint_library_t* library, const char* id) {
...
carla_actor_blueprint_t** carla_blueprint_library_filter(carla_blueprint_library_t* library, 
    ...
    if (library && library->library && wildcard_pattern && out_count) {
        try {
            ...
            *out_count = filtered->size();
            ...
            auto** result = (carla_actor_blueprint_t**)calloc(*out_count, sizeof(carla_actor_blueprint_t*));
            size_t i = 0;
...
const char* carla_actor_blueprint_get_id(const carla_actor_blueprint_t* blueprint) {
...
bool carla_actor_blueprint_has_tag(const carla_actor_blueprint_t* blueprint, const char* tag) {
...
bool carla_actor_blueprint_match_tags(const carla_actor_blueprint_t* blueprint, const char* wildcard_pattern) {
...
size_t carla_actor_blueprint_get_attribute_count(const carla_actor_blueprint_t* blueprint) {
    if (blueprint && blueprint->blueprint) {
...
carla_actor_attribute_t* carla_actor_blueprint_get_attribute(const carla_actor_blueprint_t* blueprint, size_t index) {
    if (blueprint && blueprint->blueprint && index < blueprint->blueprint->size()) {
...
carla_actor_attribute_t* carla_actor_blueprint_find_attribute(const carla_actor_blueprint_t* blueprint, const char* id) {
...
bool carla_actor_blueprint_set_attribute(carla_actor_blueprint_t* blueprint, const char* id, const char* value) {
...
const char* carla_actor_attribute_get_id(const carla_actor_attribute_t* attribute) {
...
const char* carla_actor_attribute_get_value(const carla_actor_attribute_t* attribute) {
    if (attribute && attribute->attribute) {
...
bool carla_actor_attribute_is_modifiable(const carla_actor_attribute_t* attribute) {
    if (attribute && attribute->attribute) {
