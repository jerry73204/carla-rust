...
public:
    ...
    const LightState& as_builtin() const { return reinterpret_cast<const LightState&>(*this); }
};

static_assert(sizeof(FfiClientLightState) == sizeof(LightState),
              "FfiClientLightState size is not correct");
}  // namespace client
}  // namespace carla_rust
